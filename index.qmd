...
<div style="background-image: url('images/bg_hero.webp'); 
    ...
    <a href="404.html" style="background-color: #007BFF; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.4);">View My Resume (PDF)</a>
