...
.square {
    width: calc(50% - 20px); /* 50% for 2 in a row, minus margin */
    margin: 10px;
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);
    padding: 20px;
    background: white; /* Background color for the square */
    text-align: center;
}
...
<body>
    <div class="container">
        ...
        <div class="square resume">
            ...
            <h3>Data Science</h3>
            <br>
            <a href="resumes/resume_ds.pdf" class="button" target="_blank">Download</a>
        </div>

        <!-- Data Science Go Section -->
        <div class="square data-science-go">
            <lord-icon
            ...
            <br>
            <a href="resumes/resume_de.pdf" class="button" target="_blank">Access</a>
        </div>
